...
function() {
    ...
    c.registerSound = function(a, b, d, e) {
        ...
        if (!g)
            return !1;
        if (c._preloadHash[f.src] || (c._preloadHash[f.src] = []),
        c._preloadHash[f.src].push(f),
        1 == c._preloadHash[f.src].length)
            g.on("complete", createjs.proxy(this._handleLoadComplete, this)),
            g.on("error", createjs.proxy(this._handleLoadError, this)),
            c.activePlugin.preload(g);
    ...
    c._playInstance = function(a, b, d, e, f, g, h) {
        if (b instanceof Object && (d = b.delay,
        e = b.offset,
        f = b.loop,
        g = b.volume,
        h = b.pan,
...
function() {
    ...
    b.play = function(a, b, c, d, e, f) {
        ...
        null != d && this.setLoop(d),
        null != e && this.setVolume(e),
        null != f && this.setPan(f),
...
function() {
    ...
    b.register = function(a) {
        if (this._audioSources[a.src] = !0,
        this._soundInstances[a.src] = [],
        this._loaders[a.src])
            return this._loaders[a.src];
        var b = new this._loaderClass(a);
        return b.on("complete", createjs.proxy(this._handlePreloadComplete, this)),
...
function() {
    ...
    c.get = function(b) {
        var d = c.tags[b];
        return null == d && (d = c.tags[b] = new a(b)),
        d
    }
    ,
    c.remove = function(a) {
        var b = c.tags[a];
        return null == b ? !1 : (b.removeAll(),
        delete c.tags[a],
        !0)
    }
    ,
...
function() {
    ...
    b._handleCleanUp = function() {
        ...
        if (null != a) {
            ...
            createjs.HTMLAudioTagPool.setInstance(this.src, a),
            this._playbackResource = null
        }
    }
    ,
